Отлично! Создаю файл с продвинутыми и редко используемыми командами Docker.

---

**[file name]: 3 - Advanced Docker Commands.md**
**[file content begin]**
...
Отлично! Раздел "Команды и операции" теперь полностью завершен! 🎉

**Статус выполнения:**

- ✅ Оглавление раздела
- ✅ Docker CLI Reference (структурированный справочник)
- ✅ Docker Compose Guide
- ✅ Docker System Management
- ✅ Advanced Docker Commands

Переходим к следующему разделу - **"Безопасность"**? 🔒
